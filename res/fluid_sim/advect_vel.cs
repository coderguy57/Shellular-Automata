...
void main() {
    ...
    vec2 scale = pos - pos0;
    vec2 d00 = get_color(pos0.x, pos0.y, inputImage).xy;
    vec2 d01 = get_color(pos0.x, pos1.y, inputImage).xy;
    vec2 d10 = get_color(pos1.x, pos0.y, inputImage).xy;
    vec2 d11 = get_color(pos1.x, pos1.y, inputImage).xy;
